 ...
 * regras do país que, no caso do Brasil, é 20% para valores até 100.00, ou 15% para valores acima 
 * de 100.00. Fazer um programa que lê os dados da locação (modelo do carro, instante inicial e 
 * final da locação), bem como o valor por hora e o valor diário de locação.
